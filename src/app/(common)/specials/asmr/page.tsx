  ...
  return (
    <article className='flex flex-col gap-10'>
      <section className='space-y-3'>
        ...
        <p className='leading-relaxed'>taiyがひたすら音声作品を紹介するページです。成人向けサイトのリンクを含むことがあります。</p>
      </section>
      <section className='space-y-6 [counter-reset:asmr-count_0]'>
        <div className='space-y-3'>
          ...
          <p className='leading-relaxed'>まずは全年齢向けの音声作品を紹介します。</p>
        </div>
        <section className='space-y-2 [counter-increment:asmr-count_1]'>
          <h3 className='text-base font-bold before:content-[counter(asmr-count)_"._"]'>
            ...
            <LinkText href='https://www.dlsite.com/home/work/=/product_id/RJ343025.html'>
        ...
        <section className='space-y-2 [counter-increment:asmr-count_1]'>
          <h3 className='text-base font-bold before:content-[counter(asmr-count)_"._"]'>
            <ASMRAgeBadge type='general' />
            <LinkText href='https://www.dlsite.com/home/work/=/product_id/RJ397394.html'>
        ...
        <section className='space-y-2 [counter-increment:asmr-count_1]'>
          <h3 className='text-base font-bold before:content-[counter(asmr-count)_"._"]'>
            <ASMRAgeBadge type='general' />
            <LinkText href='https://www.dlsite.com/home/work/=/product_id/RJ01019302.html'>
        ...
        <section className='space-y-2 [counter-increment:asmr-count_1]'>
          <h3 className='text-base font-bold before:content-[counter(asmr-count)_"._"]'>
            ...
            <LinkText href='https://www.dlsite.com/maniax/work/=/product_id/RJ01129638.html'>
              不眠症の眠り姫～あなたと眠る異世界生活～
            </LinkText>
          </h3>
        ...
        <section className='space-y-2 [counter-increment:asmr-count_1]'>
          <h3 className='text-base font-bold before:content-[counter(asmr-count)_"._"]'>
            <ASMRAgeBadge type='teen' />
            <LinkText href='https://www.dlsite.com/maniax/work/=/product_id/RJ01189053.html'>
      ...
      <section className='space-y-6 [counter-reset:asmr-count_0]'>
        <div className='space-y-3'>
          ...
          <p className='leading-relaxed'>最後に成人向けの音声作品を紹介します。</p>
        </div>
        <section className='space-y-2 [counter-increment:asmr-count_1]'>
          <h3 className='text-base font-bold before:content-[counter(asmr-count)_"._"]'>
            <ASMRAgeBadge type='adult' />
            <LinkText href='https://www.dlsite.com/maniax/work/=/product_id/RJ270963.html'>
          ...
          <p className='leading-relaxed'>この作品はシリーズ1作目です。<LinkText href='https://www.dlsite.com/maniax/work/=/product_id/RJ297281.html' aria-label='白猫ダウナーと過ごす甘くて爽やかなえちえちサマーバケーション'>2作目</LinkText>と<LinkText href='https://www.dlsite.com/maniax/work/=/product_id/RJ353250.html' aria-label='白猫ダウナーを永遠に愛でたくなる最上級の幸せ音声'>3作目</LinkText>もよろしくお願いします。</p>
        </section>
        <section className='space-y-2 [counter-increment:asmr-count_1]'>
          <h3 className='text-base font-bold before:content-[counter(asmr-count)_"._"]'>
            <ASMRAgeBadge type='adult' />
            <LinkText href='https://www.dlsite.com/maniax/work/=/product_id/RJ318205.html'>
              あまあま小悪魔～超密着0距離音声～
            </LinkText>
          </h3>
          <p className='leading-relaxed'>小悪魔属性のヒロインたちとあまあまえっちするお話です。いつもお世話になっております。</p>
          <p className='leading-relaxed'>この作品はシリーズ1作目です。<LinkText href='https://www.dlsite.com/maniax/work/=/product_id/RJ381836.html' aria-label='あまあま小悪魔2～超密着0距離ご奉仕～'>2作目</LinkText>もよろしくお願いします。</p>
        </section>
        <section className='space-y-2 [counter-increment:asmr-count_1]'>
          <h3 className='text-base font-bold before:content-[counter(asmr-count)_"._"]'>
            <ASMRAgeBadge type='adult' />
            <LinkText href='https://www.dlsite.com/maniax/work/=/product_id/RJ424711.html'>
              ばぶ耳りふれ！
            </LinkText>
          </h3>
          <p className='leading-relaxed'>ちかちゃんとかなちゃんに、気持ちいい音を聴かせてもらったり、気持ちいいことをさせてもらったりするお話です。</p>
          <p className='leading-relaxed'>姉妹店の<LinkText href='https://www.dlsite.com/maniax/work/=/product_id/RJ277473.html'>JK耳リフレ！</LinkText>もよろしくお願いします。</p>
        </section>
        <section className='space-y-2 [counter-increment:asmr-count_1]'>
          <h3 className='text-base font-bold before:content-[counter(asmr-count)_"._"]'>
            <ASMRAgeBadge type='adult' />
            <LinkText href='https://www.dlsite.com/maniax/work/=/product_id/RJ01092090.html'>
        ...
        <section className='space-y-2 [counter-increment:asmr-count_1]'>
          <h3 className='text-base font-bold before:content-[counter(asmr-count)_"._"]'>
            <ASMRAgeBadge type='adult' />
            <LinkText href='https://www.dlsite.com/maniax/work/=/product_id/RJ01127400.html'>
              おふとんあたためようかい
            </LinkText>
          </h3>
